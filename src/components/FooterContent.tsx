        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="widget">
              ...
              <ul className="link-list">
                <li>
                  The school aims to encourage a child to do wonders, to think,
                  to feel, and to imagine by out Quality Education.
                </li>
                <li>
                  <a href="#">
                    Our School Provides Your Child the quality material so that
                    the study will not bother him..
                  </a>
                </li>
                <li>
                  Our School always try to appreciate students so that they can
                  motivate them to achieve more and more in their life
                </li>
              </ul>
            </div>
          </div>
